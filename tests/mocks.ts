...
export type MockCSSKeyframeRule =
  sinon.SinonStubbedInstance<DevTools.CSSRule.CSSKeyframeRule>;
...
export interface MockCSSMatchedStylesParams {
  ...
  inheritedStylesSet?: Set<DevTools.CSSStyleDeclaration.CSSStyleDeclaration>;
}
...
export function createMockCSSMatchedStyles(
  ...
  mock.isInherited.callsFake(style => inheritedStylesSet.has(style));
